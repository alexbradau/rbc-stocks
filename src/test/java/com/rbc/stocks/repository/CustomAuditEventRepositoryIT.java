...
import com.rbc.stocks.config.audit.AuditEventConverter;
import com.rbc.stocks.domain.PersistentAuditEvent;
...
import static com.rbc.stocks.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
